...
- You can load and run your package at any point along its development history. This can be tremendously useful with tools like <b style='color:#f03c15'>[bisectr](https://github.com/wch/bisectr)</b>, which allow you to use binary search to quickly find the commit that introduced a bug.
